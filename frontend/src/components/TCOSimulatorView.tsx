        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-5 shadow-md">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2.5 text-sm text-accent font-black focus:outline-none focus:border-cyan-500 cursor-pointer shadow-sm"
            >
          ...
          <div>
            <div className="flex justify-between text-xs mb-1.5">
              ...
              <span className="font-mono text-accent font-black text-sm">{inputTokensMillions}M</span>
            </div>
            <input
          ...
          <div>
            <div className="flex justify-between text-xs mb-1.5">
              ...
              <span className="font-mono text-accent font-black text-sm">{outputTokensMillions}M</span>
            </div>
            <input
            ...
            <>
              ...
              <div className="p-5 rounded-2xl bg-cyan-50 dark:bg-cyan-950/40 border border-cyan-300 dark:border-cyan-500/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-muted font-extrabold">{t.tco.recommendedOption}</div>
              ...
              {/* Break-even Insight */}
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-muted space-y-1 shadow-sm">
