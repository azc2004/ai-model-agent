...
export const LeaderboardView: React.FC<LeaderboardViewProps> = ({ models }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Title */}
      <div className="glass-panel p-6 md:p-8 rounded-3xl border border-slate-300 dark:border-slate-800 shadow-xl">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl font-black text-xs transition-all shadow-sm ${
            activeBenchmark === 'arena'
              ...
              : 'bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-300 dark:hover:bg-slate-700 border border-slate-300 dark:border-slate-700'
          }`}
        >
      ...
      {/* Leaderboard Table */}
      <div className="glass-panel rounded-3xl border border-slate-300 dark:border-slate-800 overflow-hidden shadow-xl">
